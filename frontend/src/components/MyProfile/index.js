...
import {
  Icon, Divider, Header, Table, Image, Grid, Segment, Form, Modal, Button, Dimmer, Loader,
  Breadcrumb,
    ...
    <>
      {loading && (
        <Dimmer active inverted>
          <Loader size="massive">Modification du profil en cours</Loader>
        </Dimmer>
      )}
      {!loading && (
        <>
          <Segment basic padded>
            <Breadcrumb size="large">
              ...
              <Breadcrumb.Section active>Mon profil</Breadcrumb.Section>
            </Breadcrumb>
          </Segment>
